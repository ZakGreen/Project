...
public class Tester extends JFrame implements ItemListener
{
    ...
    public void itemStateChanged(ItemEvent e)
    {
        if (e.getSource() == combo)
        {
            ...
            {
                label2.setText(" - страна с самой опасной фауной!");
            }
            else if (combo.getSelectedItem()=="Россия")
            {
                label2.setText(" - страна с vodka, balalayka, bears!");
            }
            else if (combo.getSelectedItem()=="Китай")
            {
                label2.setText(" - страна: +10 soсial credit, миска рис, кошка-жена!");
            }
            else if (combo.getSelectedItem()=="Англия")
            {
                label2.setText(" - London is capital of GB!");
            }
        }
    }
}
